...
function updateState() {
    $(document).ready(function () {
        ...
        let QCount = 4; //replace with getQCount
        let curr = 0; //replace with current question nr.
        let solution = "1000010000100001"; //replace with getSolution
        //____________________________________________
        let stateObj = { state: "" };
        ...
        curr++; //delete
        if (curr == QCount) {
            evaluate(solution, stateToAnswers(questionListString));
        }
        //____________________________________________
    });
}
